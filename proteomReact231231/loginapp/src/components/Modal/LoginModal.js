...
function LoginModal(props){
  let [JoinLoign,setJoinLogin] = useState('sign-in')
          ...
          <form>
            {
              ...
              ?(
                <>
                <input type="text" placeholder="please enter your ID" onChange={handleNameChange}/>
